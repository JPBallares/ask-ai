...
export default function Home() {
  ...
  return (
    <main ref={messagesContainerRef} className="flex min-h-screen max-h-screen overflow-auto flex-col items-center justify-between p-24" style={{ scrollBehavior: 'smooth' }}>
